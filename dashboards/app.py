...
fig_avg_price_by_month = px.bar(avg_price_by_month, x="datetime", y="price", 
              labels={"datetime": "Date", "price": "Average price of houses"},
              hover_data={"datetime": "|%B %d, %Y"},
              title='Average monthly price of houses for sale')

fig_avg_price_per_meter_by_month  = px.bar(avg_price_per_meter_by_month, x="datetime", y="price_per_meter",
              labels={"datetime": "Date", "price_per_meter": "Average price per meter of houses"},
              hover_data={"datetime": "|%B %d, %Y"},
              title='Average monthly price per meter of houses for sale')

fig_median_price_by_month = px.bar(median_price_by_month, x="datetime", y="price",
                labels={"datetime": "Date", "price": "Median price of houses"},
                hover_data={"datetime": "|%B %d, %Y"},
                title='Median price of houses for sale')   

fig_median_price_per_meter_by_month = px.bar(median_price_per_meter_by_month, x="datetime", y="price_per_meter",
                labels={"datetime": "Date", "price_per_meter": "Median price per meter of houses"},
                hover_data={"datetime": "|%B %d, %Y"},
                title='Median price per meter of houses for sale')

fig_number_of_houses_for_sale_per_month = px.bar(number_of_houses_for_sale_per_month, x="datetime", y="scrapping_date",
                labels={"datetime": "Date", "scrapping_date": "Number of houses for sale"},
                hover_data={"datetime": "|%B %d, %Y"},
                title='Number of houses for sale per month')       

fig_monthly_avg_price_houses_sold = px.bar(monthly_avg_price_houses_sold, x="date_of_sale", y="price",
                labels={"date_of_sale": "Date", "price": "Average price of houses"},
                hover_data={"date_of_sale": "|%B %d, %Y"},
                title='Monthly average price of houses sold.')  

fig_monthly_avg_price_per_meter_houses_sold = px.bar(monthly_avg_price_per_meter_houses_sold, x="date_of_sale", y="price_per_meter",
                labels={"date_of_sale": "Date", "price_per_meter": "Average price per meter of houses"},
                hover_data={"date_of_sale": "|%B %d, %Y"},
                title='Monthly average price per meter of houses sold.' )    
...
fig_monthly_median_price_per_meter_houses_sold = px.bar(monthly_median_price_per_meter_houses_sold, x="date_of_sale", y="price_per_meter",
              labels={"date_of_sale": "Date", "price_per_meter": "Median price per meter of houses"},
              hover_data={"date_of_sale": "|%B %d, %Y"},
...
#    html.P('Monthly average price of houses sold.'), 
    dcc.Graph(figure=fig_monthly_avg_price_houses_sold),
   
 #  html.P('Monthly average price per meter of houses sold.'), 
    dcc.Graph(figure=fig_monthly_avg_price_per_meter_houses_sold),
